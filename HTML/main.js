...
const messages = [
   "Toca en cualquier parte, sí?",
   "HOLA ",
   "Quiero decirte algo",
   "Prueba a presionar",
   "Presiona otra vez",
   "Vamos, sigue presionando con ánimo",
    "Te prometo que esta es la última",
   "En serio",
   "Esto",
   "Es lo último",
   "¡Pero era broma! Hehe, vamos jaja",
   "Sé que seguro estás molesta",
   "Hmmm",
   "Bueno, está bien",
   "De hecho",
   "Solo quería decirte",
   "Fui al mercado a comprar leche, pero de regreso no podía dejar de pensar en ti." ,
    "Loviu❤️",
    "¡Rayos!",
    "Prueba a presionar el botón de abajo 💝"
];
